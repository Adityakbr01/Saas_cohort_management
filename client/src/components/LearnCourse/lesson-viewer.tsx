...
export default function LessonViewer({ lesson, onComplete, toggleBookmark, selectedLesson, cohortId }: LessonViewerProps) {
      ...
      <CardContent>
        {lesson.type === "video" && lesson.videoUrl ? (
          <div className="mb-6 flex justify-center items-center w-full">
            <div className="w-full max-w-5xl aspect-video rounded-lg overflow-hidden shadow-lg border p-0 bg-black relative">
              <HLSPlayer
                onMarkComplete={HandleComplate}
                lessonId={lesson.id}
                cohortId={cohortId}
