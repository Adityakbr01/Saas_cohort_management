        ...
        <TabsContent value="general" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update your general account information</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="company-name">Company Name</Label>
                  <Input id="company-name" defaultValue="AdminHub Pro" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="description" placeholder="Enter company description..." />
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="billing-email" defaultValue="billing@company.com" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 border rounded-lg">
                  ...
                  <div className="text-sm text-muted-foreground">$99/month • Next billing: Jan 15, 2024</div>
                </div>
              </div>
